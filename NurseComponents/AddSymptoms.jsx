...
export default function AddSymptoms({ navigation ,route}) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const response = await axios.post(`${API_BASE_URL}/nurse/addSymptoms/${patientId}`, symptoms,
            {
                headers: {
        ...
        <View style={styles.container}>
            ...
            <ImageBackground source={BG_Symptoms} style={styles.content}>
                ...
                <View style={styles.formcontent}>
                        <Text style={styles.heading}>Symptoms Matter: Add Your Patient's Signals!</Text>
                        <View style={styles.inputRow}>
    <View style={styles.inputColumn}>
        <View style={styles.inputContainer}>
            <Text style={styles.label}>Symptom 1:<Text style={styles.redStar}>*</Text></Text>
            <TextInput
    style={styles.input}
