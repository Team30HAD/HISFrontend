...
import { StyleSheet, View, Text, Image, ScrollView ,TouchableOpacity, Modal, ImageBackground } from 'react-native';
  ...
  useEffect(() => {
    ...
    const fetchPatientImages = async () => {
      try {
        ...
        const response = await axios.get(`${API_BASE_URL}/nurse/viewSymptomImages/${patientId}`,{
          headers: {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.heading}>View Symptoms: Exploring Patient Expressions</Text>
          <TouchableOpacity style={styles.addButton} onPress={() => handleadd(patientId)}>
