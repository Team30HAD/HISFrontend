  ...
  useEffect(() => {
    ...
    const fetchPatientImages = async () => {
      try {
        ...
        const response = await axios.get(`${API_BASE_URL}/nurse/viewPastImages/${historyId}`,{
          headers: {
...
const handleDelete = async (imgId) => {
  try {
    const token = await AsyncStorage.getItem('token');
      ...
      setIsLoading(true);
      navigation.navigate('ViewPastImage',{historyId})
  } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.heading}>View Images: For Selected Medical History</Text>
