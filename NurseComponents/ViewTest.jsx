    ...
    useEffect(() => {
        const fetchTests = async () => {
            try {
                ...
                const response = await axios.get(`${API_BASE_URL}/nurse/viewTest/${patientId}`, {
                    headers: {
                ...
                <ScrollView contentContainerStyle={styles.scrollView}>
                    ...
                    <View style={styles.tableContainer}>
                        <Table borderStyle={{ borderColor: 'transparent' }}>
                            <Row data={['S.No', 'Test Name', 'Result', 'Prescribed On', 'Action']} style={styles.tableHeader} textStyle={styles.headerText} />
                            <Rows
...
<SemicircleBackground style={styles.rbackground}>
  <TouchableOpacity onPress={() => navigation.navigate('AddTestResult', { patientId })} style={styles.footerItem}>
