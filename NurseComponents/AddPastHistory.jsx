...
export default function AddPastHistory({ navigation, route }) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const response = await axios.post(`${API_BASE_URL}/nurse/addPastHistory/${patientId}`, {
                ...pastHistory,
            }, {
                headers: {
            ...
            <ImageBackground source={BG_PastHistory} style={styles.content}>
                ...
                <ScrollView contentContainerStyle={styles.formContainer}>
                    <View style={styles.formcontent}>
                        <Text style={styles.heading}>Patient's Health Journey: Add Past Medical History</Text>
