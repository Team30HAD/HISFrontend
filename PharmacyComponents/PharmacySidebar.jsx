  ...
  return (
    <View style={styles.container}>
      <View style={styles.profileContainer}>
        <Image source={{uri:"https://t4.ftcdn.net/jpg/01/10/40/85/360_F_110408571_MKABH1lRABlrn4aK6gUsWhFv9gTdSMOe.jpg"}} style={styles.profileImage} />
      
        {pharmacyDetails ? (
              <>
                <Text style={styles.profileText}>{pharmacyDetails.name}</Text>
                <Text style={styles.profileText}>Contact: {pharmacyDetails.contact}</Text>
                <Text style={styles.profileText}>Email: {pharmacyDetails.email}</Text>
              </>
            ) : (
      ...
      <TouchableOpacity onPress={navigateToScreen('PharmacyHome')}>
        <Text style={[styles.item, activeRoute === 'PharmacyHome' && styles.activeItem]}>Home</Text>
      </TouchableOpacity>
      <View style={styles.line}></View>
      <TouchableOpacity onPress={navigateToScreen('PharmacyPatient_Details')}>
        <Text style={[styles.item, activeRoute === 'PharmacyPatient_Details' && styles.activeItem]}>View Prescriptions</Text>
      </TouchableOpacity>
      <View style={styles.line}></View>
