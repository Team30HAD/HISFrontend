  ...
  const fetchOldSymptomImage = async () => {
      try {
        const token = await AsyncStorage.getItem('token');
          const response = await axios.get(`${API_BASE_URL}/nurse/viewSymptomImagesById/${patientId}/${id}`,{
            headers: {
    ...
    const handleImageUpload = async () => {
      try {
        ...
        const token = await AsyncStorage.getItem('token');
        const response = await axios.put(`${API_BASE_URL}/nurse/editSymptomImages/${id}`, { image, description },{
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
    ...
    return (
      ...
      >
          ...
          <Text style={styles.headerText}>Modify Patient Symptoms: Upload Images with Descriptions</Text>
